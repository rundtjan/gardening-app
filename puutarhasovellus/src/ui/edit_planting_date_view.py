...
class EditPlantingDateView:
    ...
    def _initialize(self):
        ...
        self._cal = Calendar(self._frame, selectmode = "day", year=self._plant_date.year, month=self._plant_date.month, day=self._plant_date.day)
        edit_planting_date_button = ttk.Button(master=self._frame, text="Save", command=self._edit_planting_date)
        ...
        edit_planting_date_button.grid(row=3, column=0, columnspan=2, padx=5, pady=5, sticky=(constants.E, constants.W))
